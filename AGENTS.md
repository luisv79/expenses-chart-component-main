...
### Challenge Overview
This project involves building a bar chart component based on the design specifications provided in the `/design` folder. The goal is to create a responsive and interactive chart that:
- Highlights the current day's bar in a different color.
- Displays the correct amounts for each day on hover.
- Adapts to different screen sizes.

Refer to the [README.md](README.md) for detailed user stories and requirements.

### Key Resources
- [README.md](README.md): Contains the challenge details, user stories, and requirements.
- [style-guide.md](style-guide.md): Provides the color palette, fonts, and other design specifications.
